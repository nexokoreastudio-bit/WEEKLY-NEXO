/**
 * 2월 9일 발행호의 article과 insight 데이터 확인
 */
...
async function checkFeb9Data() {
  ...
  const { data: insights } = await supabase
    ...
    .or(`published_at.gte.2026-02-09T00:00:00Z,published_at.lt.2026-02-10T00:00:00Z,edition_id.eq.${editionId}`)
